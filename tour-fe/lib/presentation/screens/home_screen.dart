...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildHeader(String greeting, String subtitle) {
    return Container(
      ...
      clipBehavior: Clip.antiAlias, // đảm bảo không bị tràn pixel
      child: Stack(
        children: [
          Positioned(
            top: 0,
    ...
    return Column(
      children: tours.map((tour) {
        ...
        return Container(
          ...
          clipBehavior: Clip.antiAlias, // bo tròn hẳn, tránh tràn
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Stack(
                    ...
                    Row(
                      children: [
                        const Icon(
                          ...
                          size: 20,
                          color: Color.fromARGB(255, 172, 164, 2),
                        ),
