...
import 'package:tour_fe/presentation/widgets/Tours_Latest.dart';
import '../widgets/Image_Carousel.dart';
import '../widgets/Tours_Place.dart';
import '../widgets/NavigationBar.dart';
import 'package:tour_fe/presentation/widgets/Search_Tour.dart';
        ...
        if (!isSearching) ...[
          ...
          FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              return ToursLatest(tours: snapshot.data!);
            },
          ),
        ],
      ],
